...
@info "Running L-shaped benchmarks on 2 workers..."
dab = prepare_dbenchmark(1000, 10); warmup_benchmarks!(dab); run_benchmarks!(dab); save_results!(dab, "ls_scaling_2.json")
exit()
