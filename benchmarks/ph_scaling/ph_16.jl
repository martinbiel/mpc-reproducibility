...
@info "Running progressive-hedging benchmarks on 16 workers..."
dab = prepare_dbenchmark(1000, 5); warmup_benchmarks!(dab); run_benchmarks!(dab); save_results!(dab, "ph_16.json")
exit()
